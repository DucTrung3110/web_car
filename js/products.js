...
function loadVehicleData() {
    allVehicles = [
        ...
        },
        {
            ...
            price: 95500,
            category: 'luxury',
            image: 'https://cdn.pixabay.com/photo/2017/08/17/13/44/sports-car-2651393_960_720.jpg',
            specs: {
                engine: 'V8 TFSI',
                horsepower: '453 HP',
                drivetrain: 'AWD',
            ...
            description: 'The Audi A8 L combines cutting-edge technology with unparalleled comfort.',
            badge: 'Premium'
        },
        // Electric Vehicles
        {
        ...
        },
        {
            ...
            price: 89500,
            category: 'electric',
            image: 'https://cdn.pixabay.com/photo/2022/06/20/20/36/car-7274571_1280.jpg',
            specs: {
            ...
            description: 'BMW\'s flagship electric SUV with innovative technology and luxury.',
            badge: 'New'
        },
        {
            id: 6,
            ...
            description: 'Mercedes\' luxury electric sedan with exceptional range and comfort.',
            badge: 'Electric'
        },
        // Sports Cars
        {
            ...
            price: 235000,
            category: 'sports',
            image: 'https://cdn.pixabay.com/photo/2017/10/18/10/47/auto-2863638_1280.jpg',
            specs: {
            ...
            description: 'The ultimate 911 combines everyday usability with track performance.',
            badge: 'Performance'
        },
        {
            id: 8,
            ...
            price: 185000,
            category: 'sports',
            image: 'https://cdn.pixabay.com/photo/2023/07/29/16/42/car-8157299_1280.jpg',
            specs: {
                engine: 'Twin Turbo V8',
                horsepower: '617 HP',
                drivetrain: 'AWD',
        ...
        },
        {
            ...
            price: 195000,
            category: 'sports',
            image: 'https://cdn.pixabay.com/photo/2022/05/12/12/30/racing-7191479_960_720.jpg',
            specs: {
                engine: 'Twin Turbo V8',
                horsepower: '630 HP',
                drivetrain: 'AWD',
...
function renderVehiclesByCategory() {
    ...
    const luxuryVehicles = filteredVehicles.filter(v => v.category === 'luxury');
    const electricVehicles = filteredVehicles.filter(v => v.category === 'electric');
    const sportsVehicles = filteredVehicles.filter(v => v.category === 'sports');
    ...
    showNoResultsMessage(luxuryVehicles.length + electricVehicles.length + sportsVehicles.length === 0);
}
        ...
        <div class="vehicle-card" data-id="${vehicle.id}" draggable="true">
            ...
            <div class="vehicle-info">
                ...
                <div class="vehicle-actions">
                    <button class="btn btn-primary" onclick="openVehicleModal(${vehicle.id})">View Details</button>
...
function applyFilters() {
    ...
    if (categoryFilter && categoryFilter.value !== 'all') {
        filtered = filtered.filter(vehicle => vehicle.category === categoryFilter.value);
    }
...
function openVehicleModal(vehicleId) {
    ...
    contactBtn.onclick = () => {
        window.location.href = `contact.html?vehicle=${encodeURIComponent(vehicle.name)}`;
    };
...
function showNoResultsMessage(showMessage = false) {
    ...
    if (showMessage) {
        if (!noResultsDiv) {
            ...
            if (filtersSection) {
                filtersSection.parentNode.insertBefore(noResultsDiv, filtersSection.nextSibling);
            }
        }
